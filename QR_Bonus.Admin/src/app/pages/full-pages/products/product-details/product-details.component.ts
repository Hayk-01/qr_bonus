...
export class ProductDetailsComponent implements OnInit {
  ...
  public data: ProductModel = {} as ProductModel;
  ...
  private async getData() {
    let res = await this.http.get<ProductModel>(Urls.Product, {}, parseInt(this.id)).toPromise();
  ...
  public async onSubmit() {
    ...
    let reqBody: ProductModel = this.form.value;
    if(this.addPhoto) {
    ...
    if(this.type === PageType.new) {
      res = await this.http.post(Urls.Product, reqBody).toPromise();
    } else {
      res = await this.http.put(Urls.Product, reqBody, reqBody.id).toPromise();
    }
